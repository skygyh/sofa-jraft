...
if [[ $JAVA_VERSION =~ "1.8" ]]; then
  ...
  JAVA_OPT_2="-XX:+UseConcMarkSweepGC -XX:+UseParNewGC -XX:CMSInitiatingOccupancyFraction=60 -XX:+CMSParallelRemarkEnabled -XX:+UseCMSInitiatingOccupancyOnly -XX:SoftRefLRUPolicyMSPerMB=0 -XX:+CMSClassUnloadingEnabled -XX:+DisableExplicitGC -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=benchmark.hprof -XX:+UnlockDiagnosticVMOptions -XX:+ExitOnOutOfMemoryError -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:+PrintGCApplicationConcurrentTime -XX:+PrintGCApplicationStoppedTime -XX:+PrintTenuringDistribution -Xloggc:benchmark.gc.log"
else
...
server 10.255.93.15:18091,10.255.93.16:18091,10.255.93.17:18091 ../../../config/benchmark_server_pmem.yaml
true $1 10 0 1000000 64 1024
EOF
