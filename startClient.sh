...
mvn -pl jraft-example exec:java -Dexec.mainClass=com.alipay.sofa.jraft.benchmark.client.BenchmarkClient -Dexec.classpathScope=test  -Dexec.args="client 10.255.93.15:18091,10.255.93.16:18091,10.255.93.17:18091 jraft-example/config/benchmark_client_pmem.yaml $1 10 0 10000000 64 1024" > client_output& 
